...
const specs: ProductSpec[] = [
  ...
  { name: "config_providers", sdkPath: "app.config.providers", description: "List available agent providers and models", capability: "config:read", effect: "read", handler: async () => ({ defaultBackend: resolveBackendId(), providers: (await getBackend()).listProviders() }) },
